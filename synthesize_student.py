...
parser.add_argument('--teacher_name', type=str, default='wavenet_01', help='Teacher Name')
parser.add_argument('--model_name', type=str, default='wavenet_student_01', help='Model Name')
